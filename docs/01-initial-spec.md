...
> Historical note: this file documents the first MVP plan and is not the current implementation guide. Use `README.md` and `CONTRIBUTING.md` for current development workflow and conventions.
