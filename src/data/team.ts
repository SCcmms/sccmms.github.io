...
export const members: MemberData[] = [
  {
    ...
    text: [
      {
        text: "Dr inż. Specjalista z kilkunastoletnim doświadczeniem w konserwacji predykcyjnej i diagnostyce technicznej.",
        bold: true,
      },
      {
  ...
  {
    name: "Bartłomiej Greń",
    text: [
      {
        text: "Inżynier z 15-letnim doświadczeniem w przemyśle (automotive, przemysł ciężki, automatyka) z czego 7 lat we wdrożeniach analityki i AI dla przemysłu. ",
        bold: true,
      },
      {
  ...
  },
  {
    ...
    text: [
      {
        text: "Absolwent Informatyki i Systemów Inteligentnych AGH, programista z 6-letnim doświadczeniem, specjalizujący się w tworzeniu aplikacji internetowych oraz zarządzaniu infrastrukturą IT.",
        bold: true,
      },
      {
  ...
  },
  {
    ...
    text: [
      {
        text: "Absolwent Matematyki Stosowanej AGH, analityk i inżynier danych z 8-letnim doświadczeniem.",
        bold: true,
      },
      {
